...
import { Entity, PrimaryColumn, Column, CreateDateColumn, UpdateDateColumn, OneToMany, ManyToMany, BeforeInsert, BeforeUpdate, Index } from 'typeorm';
...
export class User {
  ...
  farm_type: string; // 'small' | 'commercial' | 'cooperative'
  ...
  // Relationship with Farms as Moderator (many-to-many)
