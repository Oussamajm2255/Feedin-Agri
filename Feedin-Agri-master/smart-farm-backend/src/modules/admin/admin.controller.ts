...
export class AdminController {
  ...
  async getPendingAccessRequests(
    ...
    return this.adminService.getPendingAccessRequests(pageNum, limitNum);
  }

  /**
   * PATCH /admin/access-requests/:id/approve
   * Approve a pending access request (activates user account)
   */
  ...
  async approveAccessRequest(
    ...
    return this.adminService.approveAccessRequest(userId, admin?.user_id || admin?.id);
  }

  /**
   * PATCH /admin/access-requests/:id/reject
   * Reject a pending access request (suspends user account)
   */
  ...
  async rejectAccessRequest(
    ...
    return this.adminService.rejectAccessRequest(userId, admin?.user_id || admin?.id, reason);
  }
