...
@Component({
    ...
    <header class="filter-header">
      <div class="header-container">
        ...
        <div class="header-actions">
          <!-- Filter Group -->
          <div class="action-group filter-group">
            <button
              mat-icon-button
          ...
          <!-- Refresh Group -->
          <div class="action-group refresh-group">
            <button
              mat-icon-button
              (click)="refresh.emit()"
              matTooltip="Refresh"
            ...
            <button
              ...
              class="icon-btn auto-refresh-btn"
            >
          ...
          <div class="action-group view-group">
            <button
              ...
              [matTooltip]="density() === 'compact' ? 'Comfortable View' : 'Compact View'"
  ...
  styles: [
    `
      ...
      :host-context(body.dark-theme) .header-actions {
      ...
      :host-context(body.dark-theme) .filter-toggle.active:hover {
      ...
      :host-context(body.dark-theme) .refresh-btn.loading {
        color: #34d399;
      }

      :host-context(body.dark-theme) .auto-refresh-btn.active {
        background: linear-gradient(135deg, rgba(52, 211, 153, 0.25), rgba(16, 185, 129, 0.2));
        color: #6ee7b7;
      }

      :host-context(body.dark-theme) .density-btn.active {
        background: linear-gradient(135deg, rgba(52, 211, 153, 0.25), rgba(16, 185, 129, 0.2));
        color: #6ee7b7;
      }
