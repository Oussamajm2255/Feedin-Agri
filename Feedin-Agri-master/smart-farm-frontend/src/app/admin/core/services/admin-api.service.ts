...
export class AdminApiService {
   ...
   */
  getPendingAccessRequests(page: number = 1, limit: number = 20): Observable<{
    items: Array<{
      user_id: string;
      email: string;
      first_name: string;
    ...
    return this.http.get<any>(`${this.API_URL}/admin/access-requests`, { params });
  }
   ...
   */
  approveAccessRequest(userId: string): Observable<{
    message: string;
    user: { user_id: string; email: string; first_name: string; last_name: string; status: string };
  }> {
    return this.http.patch<any>(`${this.API_URL}/admin/access-requests/${userId}/approve`, {});
  }
   ...
   */
  rejectAccessRequest(userId: string, reason: string): Observable<{
    message: string;
    user: { user_id: string; email: string; first_name: string; last_name: string; status: string };
  }> {
    return this.http.patch<any>(`${this.API_URL}/admin/access-requests/${userId}/reject`, { reason });
  }
