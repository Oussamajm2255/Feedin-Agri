    ...
    <nav class="public-nav" [class.scrolled]="isScrolled()">
      <div class="nav-inner">
        ...
        <div class="nav-actions">
          ...
          <button
            class="nav-btn primary cta-expert"
            (click)="goToContactRegister()"
            aria-label="Contact Expert"
          >
            <span class="cta-sparkle material-icons">support_agent</span>
            <span class="cta-label desktop-content">{{
              'landing.nav.contactExpert' | translate
            }}</span>
    ...
    @if (mobileOpen()) {
      <div class="mobile-panel" (click)="$event.stopPropagation()">
        ...
        <div class="mobile-action-section">
          ...
          <button
            class="mobile-cta-btn primary cta-expert-mobile"
            (click)="goToContactRegister(); closeMenu()"
          >
            <span class="cta-sparkle material-icons">support_agent</span>
          ...
          <button class="mobile-cta-btn secondary" (click)="go('/login'); closeMenu()">
        ...
        <div class="mobile-nav-footer">
          ...
          <span class="mobile-copyright"
            >&copy; 2026 Feedin Green. {{ 'landing.nav.allRightsReserved' | translate }}</span
          >
        </div>
      </div>
  ...
  styles: [
    `
      ...
      .nav-btn.secondary {
        ...
        border: 1.5px solid var(--primary-green, #10b981);
      ...
      .mob-link:hover .mob-icon {
        stroke: var(--primary-green, #10b981);
      }
      ...
      .mobile-action-section .mobile-nav-label {
