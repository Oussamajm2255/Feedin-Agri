...
@Component({
    ...
    <div class="actions-container">
      ...
      <div class="kpi-header-section">
        <div class="kpi-cards-grid">
          <!-- Total Actions -->
          <div class="kpi-card glass-card hover-lift total-actions-card">
            <div class="kpi-glow-indicator total-glow"></div>
            ...
            <div class="kpi-corner-accent total-accent"></div>
          </div>

          <!-- Manual % -->
          <div class="kpi-card glass-card hover-lift manual-action-card">
            <div class="kpi-glow-indicator manual-glow"></div>
            ...
            <div class="kpi-content">
              <div class="kpi-header">
                ...
                <div class="kpi-trend-indicator" [class.up]="kpiStats().manualPercent >= 50" [class.down]="kpiStats().manualPercent < 50">
                  <mat-icon>{{ kpiStats().manualPercent >= 50 ? 'trending_up' : 'trending_down' }}</mat-icon>
                </div>
              </div>
              <div class="kpi-label">{{ languageService.t()('actions.manualPercent') }}</div>
              <div class="kpi-progress-bar">
                <div class="progress-fill manual-progress" [style.width.%]="kpiStats().manualPercent"></div>
              </div>
            </div>
            <div class="kpi-corner-accent manual-accent"></div>
          </div>

          <!-- Automated % -->
          <div class="kpi-card glass-card hover-lift auto-action-card">
            <div class="kpi-glow-indicator auto-glow"></div>
            ...
            <div class="kpi-content">
              ...
              <div class="kpi-progress-bar">
                <div class="progress-fill auto-progress" [style.width.%]="kpiStats().automatedPercent"></div>
              </div>
            </div>
            <div class="kpi-corner-accent auto-accent"></div>
          </div>

          <!-- Last Action -->
          <div class="kpi-card glass-card hover-lift last-action-card">
            <div class="kpi-glow-indicator recent-glow"></div>
            ...
            <div class="kpi-content">
              <div class="kpi-header">
                ...
                <div class="kpi-badge live">LIVE</div>
              </div>
            ...
            <div class="kpi-corner-accent recent-accent"></div>
          </div>
        </div>
      </div>
  ...
  styles: [`
    ...
    .kpi-card:hover .kpi-glow-indicator {
      opacity: 1;
      height: 4px;
    }
    ...
    .kpi-card:hover .kpi-corner-accent {
      opacity: 0.15;
      transform: scale(1.1);
    }
    ...
    .total-actions-card .kpi-value {
      background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
    }

    .manual-action-card .kpi-value {
      background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
    }

    .auto-action-card .kpi-value {
      background: linear-gradient(135deg, #10b981 0%, #059669 100%);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
    }
    ...
    :host-context(body.dark-theme) {
      ...
      .glass-card, .view-toggle-container {
