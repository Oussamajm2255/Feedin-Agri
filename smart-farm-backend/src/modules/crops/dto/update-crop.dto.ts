...
import { CropStatusEnum } from './create-crop.dto';

/**
 * UpdateCropDto
 * 
 * Business Rule: A crop can be moved to a different farm by updating farm_id.
 * The farm_id is optional during updates.
 */
