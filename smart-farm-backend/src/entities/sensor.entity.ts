 ...
 * 
 * Business Rules:
 * - Sensors belong to farms (farm_id is required)
 * - Sensors are attached to devices
 * - Sensors have NO direct relationship with crops
 * - Crops belong to farms, sensors monitor farms/fields
 */
@Entity('sensors')
export class Sensor {
  ...
  // Zone association — the biological context this sensor measures
  @Index()
  ...
  @ManyToOne(() => Zone, (zone) => zone.sensors, { nullable: true })
